      ...
      <div className="max-w-7xl mx-auto px-6 pb-10 flex gap-6">
        <aside className="w-60 shrink-0 rounded-2xl bg-slate-900 text-slate-100 shadow-lg flex flex-col">
          <div className="px-5 py-4 border-b border-slate-800">
            ...
            <p className="mt-1 font-semibold">Dashboard modes</p>
          </div>

          <nav className="flex-1 px-2 py-3 space-y-1 text-sm">
            <SidebarItem label="Creator view" active />
            <SidebarItem label="Business view" />
            <SidebarItem label="Admin view" />
            <div className="mt-4 border-t border-slate-800 pt-3" />
            <SidebarItem label="Channels & videos" />
            <SidebarItem label="Campaigns" />
            <SidebarItem label="Support tickets" />
        ...
        <main className="flex-1 space-y-6">
          <section className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
            ...
            />
            <StatCard
              label="Network centrality rank"
              value="Top 3%"
              change="↑"
              changeLabel="within selected niche"
            />
            <StatCard
              label="Active collab hotspots"
              value="18"
              change="+6"
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="lg:col-span-2 space-y-4">
              <Panel title="Subscriber & views trend">
                <ChartPlaceholder variant="area" />
              </Panel>
              <Panel title="Engagement rate by content type">
              ...
              <ul className="text-xs space-y-2 text-slate-600">
                <li>
                  <span className="font-medium text-slate-800">
                    12:14 · Graph refreshed
                  </span>{" "}
                  · “SEA Gaming Network” centrality metrics updated.
                </li>
                <li>
                  <span className="font-medium text-slate-800">
                    11:02 · New creator onboarded
                  </span>{" "}
                  · Channel “StudyWithMe CN” added to Creator view.
                </li>
                <li>
                  <span className="font-medium text-slate-800">
                    09:47 · Support ticket closed
                  </span>{" "}
                  · Campaign tracking issue on brand “Nova Energy Drink”.
                </li>
              </ul>
            </Panel>

            <Panel title="Active communities this month">
              <div className="grid grid-cols-2 gap-3 text-xs">
                <CommunityBadge name="SEA Gaming" value="5.3M views" />
                <CommunityBadge name="VTubers JP" value="3.1M views" />
                <CommunityBadge name="CN Study vlog" value="2.7M views" />
                <CommunityBadge name="Global K-pop" value="1.9M views" />
              </div>
            </Panel>
          </section>
        </main>
